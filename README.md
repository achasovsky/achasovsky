...
&ensp;&ensp;&ensp;&ensp;&nbsp; - научно-исследовательские работы.
...
- **Комбинирование регрессионного анализа и машинного обучения <br> для повышения интерпретируемости модели**
