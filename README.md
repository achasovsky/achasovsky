...
### Список проектов
#
- #### <img src='img/logo-house.png' valign='-0.2em' width='20' style='margin-left:-0.3em;'> &ensp; [Сочетание регрессионного анализа и машинного обучения для увеличения точности и интерпретируемости <br> &nbsp; &nbsp; &nbsp; &nbsp; &thinsp; &thinsp; модели](https://a-chasovsky.github.io/house-prices/)
