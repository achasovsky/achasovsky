...
- [<img src='img/logo-cards.png' valign='-0.55em' halign='-0.4em' width='23'>](https://github.com/achasovsky/credit-card-fraud-detection-dataset) &nbsp; 2Датасет Credit Card Fraud Detection - <a href='https://github.com/achasovsky/credit-card-fraud-detection-dataset'>Credit-Card-Fraud-Detection-Dataset</a>
