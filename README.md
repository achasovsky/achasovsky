...
#### <img src='img/logo-house.png' valign='-0.1em' width='20' style='margin-left:-0.2em;'> &ensp; <span style='color:red'>[Сочетание регрессионного анализа и машинного обучения для увеличения точности и интерпретируемости модели](https://a-chasovsky.github.io/house-prices/)</span>
